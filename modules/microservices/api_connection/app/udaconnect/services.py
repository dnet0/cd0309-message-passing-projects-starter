...
class ConnectionService:
    ...
    def find_contacts(person_id: int, start_date: datetime, end_date: datetime, meters=5
        ...
        person_client = PersonGrpcClient()
        person_map = person_client.get_all_persons()
...
class PersonGrpcClient:
    def __init__(self):
        self.channel = grpc.insecure_channel("person-service:5005")
